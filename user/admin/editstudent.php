	...
	if($opr=="del")
{
	...
	$sql="update student set delete_status='leave' where reg_no='$id'";
...
<script type="text/javascript">
	alert('Deactivated');
	window.location="index.php?tag=edit_admission";
	</script>
...
<div>
 <table class="table" id="example">
	...
	if($year !=""){
		$sql_sel="SElECT * FROM student WHERE year(reg_date)='$year' and delete_status='active'";
  ...
  <tr >
	...
	<td>
		<a href="?tag=edit_admission&opr=del&rs_id=<?php echo $row['reg_no'];?>" 
					onclick="return confirm('sure Deactivate?');"
					title="Deactivate"><img height="25px" src="../../upload/deactive.png" /><br><br>		
		
		<a class="buttonsss" href="?tag=view_stddetails&opr=upd&rs_id=<?php echo $row['reg_no'];?>">Edit</a><br>
	</td>
